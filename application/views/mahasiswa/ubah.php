                ...
                <div class="card-body">
                    <form action="" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="nim" name="nim" autocomplete="off" value="<?= $mahasiswa['nim'];?>">
                        ...
                        <a href="<?= base_url();?>/mahasiswa" class="btn btn-outline-primary float-right mr-2"> Batal</a>
                    </form>
                </div>
            </div>  
        </div>
